...
local ts = {
    ['@annotation']                 = { fg = colors.Rose8, bold = true },
    ['@attribute']                  = { fg = colors.Rose8, bold = true },
    ...
    ['@keyword.coroutine']          = { fg = colors.Capri8, bold = true },
    ['@keyword.conditional']        = { fg = colors.Rose8, bold = true },
    ['@keyword.debug']              = { fg = colors.Orchid8, bold = true },
    ['@keyword.directive']          = { fg = colors.Cobalt8, bold = true },
    ['@keyword.directive.define']   = { fg = colors.Cobalt8, bold = true },
    ['@keyword.exception']          = { fg = colors.Red8, bold = true },
    ['@keyword.function']           = { fg = colors.Blue8, bold = true },
    ['@keyword.import']             = { fg = colors.Raspberry8, bold = true },
    ['@keyword.operator']           = { fg = colors.Rose8, bold = true },
    ['@keyword.repeat']             = { fg = colors.Orange8, bold = true },
    ['@keyword.return']             = { fg = colors.Blue8, bold = true },
    ...
    ['@punctuation.delimiter']      = { fg = colors.Gray8 },
    ['@punctuation.special']        = { fg = colors.Rose8},
