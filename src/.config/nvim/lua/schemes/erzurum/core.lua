...
local core = {
    ...
    Search                       = { fg = colors.Yellow4, bg = colors.Yellow16 },
    MatchParen                   = { fg = colors.Yellow4, bold = true },
    ...
    Typedef                      = { fg = colors.Cobalt4, bold = true },
    PreProc                      = { fg = colors.Cobalt4, bold = true },
    Include                      = { fg = colors.Raspberry4, bold = true },
    Define                       = { fg = colors.Cobalt4, bold = true },
    Exception                    = { fg = colors.Red4, bold = true },

    PreCondit                    = { fg = colors.Rose4, bold = true },
    Conditional                  = { fg = colors.Rose4, bold = true },
    Repeat                       = { fg = colors.Orange4, bold = true },
    
    SpecialChar                  = { fg = colors.Orange12, bold = true },
    
    Special                      = { fg = colors.Rose4 },
